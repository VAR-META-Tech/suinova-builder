...
function Mention(props) {
  ...
  const { setMention } = registerTiptap.useTiptapContext();
  React.useEffect(() => {
    setMention(
...
function registerMention(loader) {
  registerTiptap.registerComponentHelper(loader, Mention, {
    name: `${registerTiptap.TIPTAP_COMPONENT_NAME}-extension-mention`,
...
exports.registerMention = registerMention;
//# sourceMappingURL=registerMention.cjs.js.map
