...
interface IBrushIcon {
  className?: string;
}

export default function BrushIcon({ className }: IBrushIcon) {
  return (
    <svg
      width="100"
      height="100"
    ...
    >
      ...
      />
      <path
        d="M51.9531 35.3912C57.246 38.3783 61.6223 42.7546 64.6094 48.0475"
        stroke="white"
        strokeWidth="3"
        strokeLinecap="round"
        strokeLinejoin="round"
...
export function registerBrushIcon(loader?: Registerable) {
  registerComponentHelper(loader, BrushIcon, {
    name: "hostless-brush-icon",
    displayName: "Brush Icon",
    props: {},
    importPath: "@plasmicpkgs/nft-builder",
    importName: "BrushIcon",
  });
}
