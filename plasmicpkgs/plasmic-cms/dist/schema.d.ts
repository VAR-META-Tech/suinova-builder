export declare const enum CmsMetaType {
    TEXT = "text",
    LONG_TEXT = "long-text",
    NUMBER = "number",
    IMAGE = "image",
...
export declare type CmsFieldMeta = CmsText | CmsLongText | CmsNumber | CmsBoolean | CmsImage | CmsFile | CmsDateTime | CmsRef | CmsRichText | CmsEnum;
export declare type CmsType = CmsFieldMeta["type"];
